        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde su surgimiento como una herramienta clave para el análisis y la toma de decisiones, la estadística descriptiva se ha convertido en un recurso esencial en múltiples disciplinas. En esta unidad, nos adentraremos en los fundamentos de la estadística descriptiva, explorando conceptos básicos, tipos de datos y fuentes de información. Además, analizaremos técnicas de tabulación, elaboración de gráficos y medidas de tendencia central y de posición, con el objetivo de transformar datos en información significativa y accionable.
              
              p #[b ¡Prepárese para desarrollar habilidades esenciales en el análisis estadístico y llevar la toma de decisiones a un nuevo nivel!]
